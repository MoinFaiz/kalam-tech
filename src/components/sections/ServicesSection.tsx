  ...
  const services = [
    {
      ...
      description:
        "Building intelligent systems that leverage AI/ML to automate complex processes and drive operational excellence.",
      image: aiSystemsImg,
      icon: Brain,
    ...
    },
    {
      ...
      description:
        "Building intelligent data systems that transform raw information into actionable insights.",
    ...
    },
    {
      ...
      description:
        "Architecting scalable, fault-tolerant systems designed for high performance and maintainability.",
    ...
    },
    {
      ...
      description:
        "Building intelligent security systems that protect against threats while ensuring regulatory compliance and data privacy.",
    ...
    },
    {
      ...
      description:
        "Managing and optimizing cloud infrastructure through seamless migration, reliable operations, and cost-effective scaling.",
      image: cloudOperationsImg,
      icon: Cloud,
      tags: ["CloudOps", "DevOps", "Reliability"],
      features: ["Cloud Monitoring", "Cloud Migration", "Cost Optimization"],
    },
  ];
